...
import 'package:firebase_auth/firebase_auth.dart'; // Changed the import
...
class AuthService {
  ...
  Future<AppUser?> addUser({
    ...
    try {
      ...
      return fbUser != null ? AppUser(id: fbUser.uid, role: role, studentIds: studentIds ?? [], name: name) : null;
    } catch (e) {
